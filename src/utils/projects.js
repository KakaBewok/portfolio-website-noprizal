...
const projects = [
  //   1
  {
    ...
    tech_stack_logo: [react_logo, tailwind_logo],
    feature:
  ...
  //   2
  {
    ...
    tech_stack_logo: [js_logo, webpack_logo, pwa_logo],
  ...
  //   5
  {
    ...
    tech_stack: 'Hapi js',
    tech_stack_logo: [js_logo, hapi_logo],
  ...
  //   9
  {
    ...
    category: 'Front-End Web',
    tech_stack: 'Webpack, PWAs and Vanila Javascript',
    tech_stack_logo: [js_logo, webpack_logo, pwa_logo],
    feature:
  ...
  //   10
  {
    ...
    tech_stack_logo: [js_logo, webpack_logo],
    feature: '-',
    data: 'https://www.themoviedb.org/',
    year: 2022,
  },
  //   11
  {
    ...
    tech_stack_logo: [php_logo, mysql_logo],
  ...
  //   13
  {
    ...
    tech_stack_logo: [html_logo, css_logo, js_logo, bs_logo],
    feature: '-',
    data: '-',
    year: 2022,
  },
